...
function initSearch() {
  ...
  request.open('GET', '/DiscoX_Documentation/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/DiscoX_Documentation/assets/css/just-the-docs-' + theme + '.css');
}
